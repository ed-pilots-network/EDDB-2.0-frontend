          ...
          >
              ...
              <HStack overflowX="auto">
                ...
                >
                  ...
                  <RenderStationTypeIcon
                    ...
                    isDark={isDark}
                  />
                  {truncateString(data.firstTrip.buyFromStationDto.name, 20)}
                </Link>
              </HStack>
              <HStack>
                <HStack alignItems="baseline">
              ...
              <HStack>
                ...
                >
                  ...
                  <RenderStationTypeIcon
                    ...
                    isDark={isDark}
                  />
                  {truncateString(data.firstTrip.sellToStationDto.name, 20)}
                </Link>
              </HStack>
              <HStack alignItems="baseline">
                <Text
            ...
            >
              ...
              <HStack overflowX="auto">
                ...
                >
                  {truncateString(
                    data.returnTrip.buyFromStationDto.system.name,
                    20,
                  )}
                </Link>
                <Link
                ...
                >
                  ...
                  <Text fontStyle="italic" as="span" fontSize="xs">
                    {`${Math.round(
                      data.returnTrip.buyFromStationDto.arrivalDistance,
                    )} ls`}
                  </Text>
                  <RenderStationTypeIcon
                    station={data.returnTrip.buyFromStationDto}
                    isDark={isDark}
                  />
                  {truncateString(data.returnTrip.buyFromStationDto.name, 20)}
                </Link>
              </HStack>
              <HStack>
                <HStack alignItems="baseline">
            ...
            <VStack alignItems="start" padding={2} width="100%" as={GridItem}>
              ...
              <HStack>
                ...
                >
                  {truncateString(
                    data.returnTrip.sellToStationDto.system.name,
                    20,
                  )}
                </Link>
                <Link
                ...
                >
                  ...
                  <Text fontStyle="italic" as="span" fontSize="xs">
                    {`${Math.round(
                      data.returnTrip.sellToStationDto.arrivalDistance,
                    )} ls`}
                  </Text>
                  <RenderStationTypeIcon
                    station={data.returnTrip.sellToStationDto}
                    isDark={isDark}
                  />
                  {truncateString(data.returnTrip.sellToStationDto.name, 20)}
                </Link>
              </HStack>
              <HStack alignItems="baseline">
                <Text
      ...
      <HStack>
        ...
        >
          <GridItem fontStyle="italic" fontWeight="700">
            {`${Math.round(+formatThousands(data.firstTrip.routeDistance))} ly`}
          </GridItem>
          ...
          <HStack as={GridItem} marginLeft={{ base: 0, sm: '25%' }}>
            <HStack minWidth="max-content">
              ...
              <Link
                ...
                overflowX="hidden"
              >
                {truncateString(data.firstTrip.sellToStationDto.name, 12)}
              </Link>
            </HStack>
          </HStack>
          <Button
